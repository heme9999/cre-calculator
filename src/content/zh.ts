...
export const zhContent: LocaleContent = {
  ...
  loanPayment: {
    metaTitle: '商业地产贷款月供计算器 — 还款摊销与气球尾款计算',
    metaDescription: '计算商业地产贷款的每月本息还款额、总利息支出、气球尾款（Balloon Payment）到期金额，并查看前12个月还款摊销表。',
    h1: '商业地产贷款月供 (Loan Payment) 计算器',
    subtitle: '计算商业地产贷款的每月本息还款额、利息成本以及气球尾款到期应付金额。',
    whatIsTitle: '商业地产贷款摊销与气球尾款是什么',
    whatIsContent: '商业地产贷款与住宅贷款有很大不同。住宅贷款常见30年固定利率，而商业地产贷款通常采用较短的到期年限（Maturity Term，如5年、7年或10年），搭配较长的摊销年限（Amortization Term，如25年或30年）。在到期日，未还清的剩余本金余额必须通过一次性“气球尾款（Balloon Payment）”偿还或重新办理再融资（Refinance）。精准区分摊销年限与到期年限，并计算月供与到期尾款，是预测现金流和防范再融资风险的关键。',
    formulaTitle: '计算公式',
    ...
    exampleTitle: '一个真实场景示例',
    exampleContent: '你申请了一笔200万美元的商业地产贷款，利率为6.5%，按25年摊销年限计算月供，到期年限为10年（到期偿还气球尾款）。\n\n你的月供为$13,496（每年$161,952）。在前10年内，你累计还款$1,619,520（其中利息$1,152,192，本金$467,328）。在第10年到期时，你需要一次性偿还剩余的气球尾款$1,532,672。',
    faqTitle: '常见问题',
    faqs: [
      {
        question: '什么是商业地产里的气球尾款 (Balloon Payment)？',
      ...
      {
        question: '利率波动对商业地产月供与还款有何影响？',
        answer: '由于商业地产贷款金额较大，哪怕 0.5% 的利率变化也会显著改变每月供款与年度还款额，从而直接影响项目的现金流、偿债覆盖率（DSCR）和 Cash-on-Cash 现金回报率。',
      },
      {
        question: '商业地产贷款是固定利率还是浮动利率？',
        answer: '商业贷款可以是 5-10 年的固定利率，也可以是锚定 SOFR 或 Prime 的浮动利率。常见模式是在到期年限内保持前 5 年或 7 年固定利率，之后按市场利率重新调整。',
      },
    ],
    relatedTitle: '相关计算器',
    relatedCalculators: [
