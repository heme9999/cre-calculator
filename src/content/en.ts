...
export const enContent: LocaleContent = {
  ...
  leaseVsBuy: {
    metaTitle: 'Lease vs Buy Calculator — Commercial Real Estate Decision Tool',
    metaDescription: 'Compare commercial property leasing versus buying total costs and net equity.',
    h1: 'Lease vs Buy Calculator',
    subtitle: 'Evaluate full lifecycle costs of leasing versus buying commercial property.',
    whatIsTitle: 'What Is Lease vs Buy',
    whatIsContent: 'Analyze financial tradeoffs between leasing and owning commercial space.',
    formulaTitle: 'Formulas',
    formulaCode: 'Total Lease Cost vs Total Buy Cost',
    formulaVariables: [],
    exampleTitle: 'Example',
    exampleContent: 'Comparing 10-year lease vs purchase',
    faqTitle: 'FAQs',
    faqs: [],
    relatedTitle: 'Related Calculators',
    relatedCalculators: [],
