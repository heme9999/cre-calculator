...
export const enContent: LocaleContent = {
  ...
  dealAnalyzer: {
    ...
    metaDescription: 'Free CRE deal analyzer and commercial property ROI calculator. Underwrite investments, calculate NOI, Cap Rate, DSCR, and Cash-on-Cash Return in one place.',
    h1: 'Commercial Real Estate Deal Analyzer',
